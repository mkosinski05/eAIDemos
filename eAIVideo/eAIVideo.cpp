...
{
    int32_t create_eAIinference_thread = -1;
    int8_t ret = 0;
    ...
    create_eAIinference_thread = pthread_create(&eAIinference_thread, NULL, R_eAIInference_thread, NULL);
    if (0 != create_eAIinference_thread)
    {
